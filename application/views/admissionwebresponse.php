...
.container1 {
    overflow: hidden;
    bbackground-color: rgba(0,0,0,0.42);
    background-image: -webkit-linear-gradient(rgba(51,51,51,0.7),rgba(0,0,0,0.7) 75%,rgba(0,0,0,0.7));
    font-family: Arial;
    width:230px;
    margin: 50px auto;
...
">
            ...
            <label>Date :</label>
            <span><?php echo $information[0]['Date'];?></span><br /><br />
  ...
  <div class="container1">
    ...
    <div class="dropdown1">
        ...
        <div class="dropdown-content1" id="myDropdown1">
            <?php foreach ($responses as $response) {
                ?>
                 <a href="<?php echo base_url().'user'; ?>/admfix1/<?php echo str_replace("/", "~~~",$response['Questions']); ?>"><?php echo $response['Questions']; ?></a>
                 <?php 
        ...
        ?>
        <h1>Web Response</h1>
        <?php echo form_open( base_url().'user/admsend'); ?>
    ...
    -->
					<textarea name="amount" id="amount" rows="1" cols="50" ></textarea><br/><br />

				<?php } 
				else { ?>
					<label>	<?php echo array_key_exists('ResponseFromQuestionPicked', $this->session->userdata['web_response']) ? ($this->session->userdata['web_response']['ResponseFromQuestionPicked']) : ''.'<br><br>'; ?></label>
				<?php } ?>
				</div>
