...
Class Emailsent_model extends CI_Model {
	...
	public function store_admemailsent() {
		...
		$insert_data = array(
			'socsecnum'=>$this->session->userdata['logged_in']['soc'],
			'dateandtime'=>date('Y-m-d H-i-s'),
			'subject'=>isset($this->session->userdata['web_response']['ItemName']) ? $this->session->userdata['web_response']['ItemName'] : '',
			'bodyofmessage'=>isset($this->session->userdata['web_response']['Questions']) ? $this->session->userdata['web_response']['Questions'] : '',
			'emailsentto'=>'financialaid@crc.edu'
